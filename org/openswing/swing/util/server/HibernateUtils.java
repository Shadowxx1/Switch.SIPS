...
public class HibernateUtils {
    ...
    private static void fillInMetaData2( //Nelson Moncada
        ...
        if (meta != null) {
            ...
            for (int i = 0; i < attrNames.length; i++) {
                ...
                if (meta.getPropertyType(attrNames[i]) instanceof ComponentType) { //Nelson Moncada
...
//    }
        ...
        for (int i = 0; i < filterAttrNames.size(); i++) {
            ...
            if (where[0].getValue() != null && where[0].getValue() instanceof List) {
                ...
                if (!where[0].getOperator().equals(Consts.IS_NOT_NULL) && !where[0].getOperator().equals(Consts.IS_NULL)) { //Nelson Moncada
                    paramTypes.add(getPropertyType(attributesTypeMap, meta, filterAttrNames.get(i).toString(), propDescriptors));
                }
            }
