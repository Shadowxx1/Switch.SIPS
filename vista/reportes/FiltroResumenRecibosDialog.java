 ...
 */
public class FiltroResumenRecibosDialog extends InternalFrame {
    ...
    public FiltroResumenRecibosDialog(Reporte reporte, String estilo) {
        initComponents();
    ...
    class FiltroRecibos extends FormController implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            recibo = ((FiltroRecibo) FiltroResumenRecibosDialog.this.form1.getVOModel().getValueObject());
            ...
            switch (jTabbedPane1.getSelectedIndex()) {
                case 0:
                    if (jComboBox1.getSelectedIndex() > 0) {
                        ...
                        Calendar desde3= Calendar.getInstance();
                        desde3.set(Calendar.MONTH, desde2.get(Calendar.MONTH));
                        desde3.set(Calendar.DATE, 1);
                        desde3.set(Calendar.YEAR, desde2.get(Calendar.YEAR)-1);
                        parametros[2] = new FilterWhereClause("fechaCobro", ">=", desde3.getTime());

                        Calendar hasta3= Calendar.getInstance();
                        hasta3.set(Calendar.MONTH, hasta2.get(Calendar.MONTH));
                        hasta3.set(Calendar.DATE, 1);
                        hasta3.set(Calendar.YEAR, hasta2.get(Calendar.YEAR)-1);
                        parametros[3] = new FilterWhereClause("fechaCobro", "<", hasta3.getTime());
