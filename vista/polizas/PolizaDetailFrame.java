...
public class PolizaDetailFrame extends DefaultDetailFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(form1, javax.swing.GroupLayout.DEFAULT_SIZE, 294, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addComponent(jPanel9, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(gridControl1, javax.swing.GroupLayout.DEFAULT_SIZE, 295, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void insertButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertButton1ActionPerformed
        ...
        if (numRec.isOk()) {
            switch (p.getRamoPoliza().getRamoContable()) {
                case PERSONA:
                    new ReciboPersonasDetailController(ReciboPersonasDetailFrame.class.getName(), null, numRec.getRecibo(), true, p, numRec.isNuevo());
                    break;
                case VEHICULO:
                    new ReciboVehiculosDetailController(ReciboVehiculosDetailFrame.class.getName(), null, numRec.getRecibo(), true, p, numRec.isNuevo());
                    break;
                case FIANZA:
                     new ReciboFianzasDetailController(ReciboFianzaDetailFrame.class.getName(), null, numRec.getRecibo(), true, p, numRec.isNuevo());
                    break;
                case PATRIMONIAL:
                    new ReciboPatrimonialesDetailController(ReciboPersonasDetailFrame.class.getName(), null, numRec.getRecibo(), true, p, numRec.isNuevo());
                    break;
