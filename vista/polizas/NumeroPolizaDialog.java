...
public class NumeroPolizaDialog extends javax.swing.JDialog {
    ...
    private RamoLookupController lookupRamoPoliza;

    public NumeroPolizaDialog(Component owner, TipoRamo tipoRamo, RamoContable ramoContable) {
        this(owner);
    ...
    public NumeroPolizaDialog(Component owner, RamoPoliza ramoPoliza) {
        this(owner);
        this.tipoRamo = ramoPoliza.getTipoRamo();
        this.ramoContable = ramoPoliza.getRamoContable();
        inicializar(owner);
    }
...
//        inicializar(owner);
    ...
    public void inicializar(Component owner) {
        initComponents();
        ...
        lookupRamoPoliza = new RamoLookupController(tipoRamo, ramoContable);
