...
import modelo.entidades.polizas.recibos.maestra.Patrimonial;
 ...
 */
public class ReciboPatrimonialDetailFrame extends DefaultDetailFrame {
...
//    private DefaultGridInternalController controllerBeneficiarios;
    ...
    private DefaultGridInternalController controllerTipoBienAsegurado;
    //private DefaultGridInternalController controllerCoberturas;
    private DefaultGridInternalController2 controllerDistribuciones;

    public ReciboPatrimonialDetailFrame() {
    }
    ...
    private void initComponents() {
        ...
        jPanel7Layout.setVerticalGroup(
            jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(textAreaControl1, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
        );
        ...
        gridControl1.setValueObjectClassName(Patrimonial.class.getName());
        ...
        codLookupColumn1.setColumnName("tipoBienAsegurado.nombre");
        codLookupColumn1.setColumnSortable(true);
        codLookupColumn1.setControllerMethodName("getTipoBienAsegurado");
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(gridControl1, javax.swing.GroupLayout.DEFAULT_SIZE, 562, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jTabbedPane2.addTab("Bienes Patrimoniales", jPanel10);
        ...
        jPanel23Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel23Layout.createSequentialGroup()
                ...
                .addGroup(jPanel23Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jTabbedPane2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 649, Short.MAX_VALUE))
                .addContainerGap())
        );
...
//            jTabbedPane1.add(jPanel32);
    ...
    public void inicializar(FormController formController, boolean addToMDIFrame) {
        inicializar((ReciboPatrimonialesDetailController) formController, addToMDIFrame);
    }

    public void inicializar(ReciboPatrimonialesDetailController formController, boolean addToMDIFrame) {
        initComponents();
...
//        gridControl1.setController(controllerBeneficiarios);
        ...
        controllerTipoBienAsegurado = new DefaultGridInternalController(ReciboPatrimonial.class.getName(), "getBienesPatrimoniales", gridControl1, null);
        gridControl1.setGridDataLocator(controllerTipoBienAsegurado);
        gridControl1.setController(controllerTipoBienAsegurado);
...
//        gridCobertura.setController(controllerCoberturas);
        ...
        DefaultLookupController tipoBienAsegurado = new DefaultLookupController(TipoBienAsegurado.class.getName());
        tipoBienAsegurado.addLookup2ParentLink("tipoBienAsegurado");
        codLookupColumn1.setLookupController(tipoBienAsegurado);
...
//        controllerBeneficiarios.setBeanVO(beanVO);
        ...
        controllerTipoBienAsegurado.setBeanVO(beanVO);
//        controllerCoberturas.setBeanVO(beanVO);
        Long id = null;
        if (beanVO != null) {
