...
public class PersonaDetailFrame extends DefaultDetailFrame {
    ...
    private DefaultGridInternalController controllerSMSs;
    ...
    private void initComponents() {
        ...
        jButton7.setToolTipText("Enviar SMS al Asegurado");
        ...
        datosNaturalLayout.setVerticalGroup(
            ...
            .addGroup(datosNaturalLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(barraNatural, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel18.setBorder(javax.swing.BorderFactory.createTitledBorder("Direcciones"));

        gridControl6.setInsertRowsOnTop(false);
        gridControl6.setMaxNumberOfRowsOnInsert(4);
        gridControl6.setReloadButton(reloadButton8);
        gridControl6.setSaveButton(saveButton4);
        gridControl6.setValueObjectClassName(SMS.class.getName());

        decimalColumn3.setColumnName("id");
        decimalColumn3.setColumnRequired(false);
        decimalColumn3.setPreferredWidth(40);
        gridControl6.getColumnContainer().add(decimalColumn3);

        textColumn10.setColumnName("motivo");
        ...
        textColumn15.setColumnName("texto");
        textColumn15.setColumnRequired(false);
        textColumn15.setEditableOnEdit(true);
        textColumn15.setEditableOnInsert(true);
        gridControl6.getColumnContainer().add(textColumn15);

        textColumn19.setColumnName("estatus");
        textColumn19.setColumnRequired(false);
        textColumn19.setEditableOnEdit(true);
        textColumn19.setEditableOnInsert(true);
        gridControl6.getColumnContainer().add(textColumn19);

        jPanel19.setLayout(new java.awt.GridLayout(3, 2, 2, 2));
        jPanel19.add(reloadButton8);
        ...
        jPanel18Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel18Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(gridControl6, javax.swing.GroupLayout.DEFAULT_SIZE, 534, Short.MAX_VALUE))
        );
        jPanel18Layout.setVerticalGroup(
            jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(gridControl6, javax.swing.GroupLayout.DEFAULT_SIZE, 549, Short.MAX_VALUE)
            .addGroup(jPanel18Layout.createSequentialGroup()
    ...
    private void insertButton39ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertButton39ActionPerformed
        ...
        if (tplc.getTipoPersona() != null) {
            for (TipoPersona tipoPersona : ((Persona) getMainPanel().getVOModel().getValueObject()).getTiposPersona()) {
                if (tipoPersona.getId() == ((TipoPersona) tplc.getTipoPersona()).getId()) {
                    return;
                }
            }
...
//        System.out.println("init");
        ...
        controllerSMSs =
                new DefaultGridInternalController(Persona.class.getName(), "getSmss", gridControl6, null);
        gridControl6.setGridDataLocator(controllerSMSs);
        gridControl6.setController(controllerSMSs);
        ...
        jButton9.addActionListener((PersonasDetailController) formController);
        jButton7.addActionListener((PersonasDetailController) formController);
