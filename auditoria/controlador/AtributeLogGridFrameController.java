 ...
 */
package auditoria.controlador;

import auditoria.modelo.AtributoValor;
...
public class AtributeLogGridFrameController extends GridController implements GridDataLocator {
    ...
    public AtributeLogGridFrameController(ArrayList<AtributoValor> data) {
        this.data = data;
        new auditoria.vista.AtributeLogGridFrame().inicializar(this, this, AtributoValor.class.getName(), null, true);
    }
