...
public class Dominios {
    ...
    public static Hashtable getDominios() {
        ...
        domains.put(
                Dominios.EstatusReciboFiltro().getDomainId(),
                Dominios.EstatusReciboFiltro());
        domains.put(
                Dominios.EstatusSiniestro().getDomainId(),
                Dominios.EstatusSiniestro());
        domains.put(
                Dominios.TipoSiniestro().getDomainId(),
                Dominios.TipoSiniestro());
        domains.put(
        ...
        domains.put(
                Dominios.EstatusLiquidacion().getDomainId(),
                Dominios.EstatusLiquidacion()); 
        domains.put(
                Dominios.TipoAsiento().getDomainId(),
                Dominios.TipoAsiento());         
        domains.put(
        ...
        domains.put(
                ...
                Dominios.Parentesco());
        domains.put(
                Dominios.GradoLicencia().getDomainId(),
                Dominios.GradoLicencia());
        domains.put(
        ...
        domains.put(Dominios.TipoNotificacion().getDomainId(),
                Dominios.TipoNotificacion());
        domains.put(Dominios.TipoSiniestro().getDomainId(),
                Dominios.TipoSiniestro());
    ...
    public static enum RamoContable {
        ...
        PERSONA, VEHICULO, FIANZA, PATRIMONIAL, RAMOS_GENERALES}
    ...
    public static enum EstatusRecibo {
        ...
        NADA, PENDIENTE_COBRO, COBRADO_PENDIENTE_COMISION, COBRADO, ANULADO
    }
    ...
    public static Domain EstatusReciboFiltro() { // Listo
        Domain dominio = new Domain("EstatusReciboFiltro");
        EstatusRecibo o[] = EstatusRecibo.values();
        dominio.addDomainPair(o[0], " ");
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum TipoNotificacion {
        ...
        PERSONALMENTE, PAGINA, TELEFONO, CORREO, CARTA
    }

    public static Domain TipoNotificacion() { // Listo
        Domain dominio = new Domain("TipoNotificacion");
        TipoNotificacion o[] = TipoNotificacion.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum TipoSiniestro {

        REEMBOLSO, CARTA_AVAL, ORDEN_REPARACION,INGRESO

    }

    public static Domain TipoSiniestro() { // Listo
        Domain dominio = new Domain("TipoSiniestro");
        TipoSiniestro o[] = TipoSiniestro.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum MotivoPerdida {
        ROBO, CHOQUE, OTRO
    }

    public static Domain MotivoPerdida() { // Listo
        Domain dominio = new Domain("MotivoPerdida");
        MotivoPerdida o[] = MotivoPerdida.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum EstatusLiquidacion {

        PENDIENTE, INGRESADA, ANULADA
    }

    public static Domain EstatusLiquidacion() { // Listo
        Domain dominio = new Domain("EstatusLiquidacion");
        EstatusLiquidacion o[] = EstatusLiquidacion.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum TipoAsiento {

        DEBITO, CREDITO, NEUTRO
    }

    public static Domain TipoAsiento() { // Listo
        Domain dominio = new Domain("TipoAsiento");
        TipoAsiento o[] = TipoAsiento.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum GradoLicencia {
        PRIMERA, SEGUNDA, TERCERA, CUARTA, QUINTA
    }

    public static Domain GradoLicencia() { // Listo
        Domain dominio = new Domain("GradoLicencia");
        GradoLicencia o[] = GradoLicencia.values();
        for (int i = 0; i
                < o.length; i++) {
            dominio.addDomainPair(o[i], o[i].toString());
        }
    ...
    public static enum Parentesco {
        ...
        TITULAR, PADRE, MADRE, CONYUGE, HIJO, HIJA, HIJASTRO, HERMANO, HERMANA, NIETO, NIETA, TIO, TIA, SOBRINO,
        SOBRINA, PRIMO, PRIMA, YERNO, YERNA, SUEGRO, SUEGRA, CUYADO, CUYADA, AHIJADO, AHIJADA, ABUELO, ABUELA, OTRO
    }
    ...
    public static enum Modulos {
        ...
        POLIZAS, COMUNICADOS, FINANCIAMIENTOS, PERSONAS, RECIBOS, SINIESTROS, VEHICULOS, ORDEN_PAGO, LIQUIDACION
    }
    ...
    public static enum CategoriaReporte {
        ...
        PERSONAS, RECIBOS, COMISIONES, RENOVACIONES, DISTRIBUCION, DEVOLUCIONES, SINIESTROS, FINANCIAMIENTOS, SUPERINTENDENDENCIA, AUDITORIAS, POLIZAS, RESUMEN
    }
    ...
    public static enum TipoVigencia {
        ...
        ANUAL, TRIMESTRAL, CUATRIMESTRAL, SEMESTRAL, MENSUAL
    }
    ...
    public static enum FiltroReporte {
        FACTURA, PERSONA, REEMBOLSO, DETALLESINIESTRO, ORDENPAGO, REMESA, SINIESTRO
    ,   RECIBO}
}
