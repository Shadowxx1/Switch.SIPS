 ...
 */
@Entity
public class TipoMovimiento2 extends BeanVO implements Serializable, Auditable {
    ...
    public TipoMovimiento2() {
    }

    public TipoMovimiento2(String idPropio, String nombre, Boolean debitoOcredito, Boolean sumaOresta, Boolean visible, AuditoriaBasica auditoria) {
