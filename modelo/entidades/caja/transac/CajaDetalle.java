...
import modelo.entidades.caja.dominio.TipoMovimiento2;
...
public class CajaDetalle extends BeanVO implements Serializable, Auditable {
    ...
    @ManyToOne()
    @BusinessKey
    private TipoMovimiento2 tipoMovimiento;
    /**
     *
     */
    @ManyToOne()
    ...
    public CajaDetalle(TipoMovimiento2 tipoMovimiento, TipoDocumentoPago tipoDocumento, TipoTarjetaCredito tipoTarjetaCredito, Persona banco, String numeroReferencia, Double debito, Double credito, AuditoriaBasica auditoria) {
    ...
    public TipoMovimiento2 getTipoMovimiento() {
        return tipoMovimiento;
    }

    public void setTipoMovimiento(TipoMovimiento2 tipoMovimiento) {
        this.tipoMovimiento = tipoMovimiento;
    }
