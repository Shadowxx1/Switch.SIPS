...
@Entity
public class TipoBienAsegurado extends BeanVO implements Serializable, Auditable {
    ...
    public TipoBienAsegurado() {
    }

    public TipoBienAsegurado(String nombre, RamoContable ramoContable, AuditoriaBasica auditoria) {
        this.nombre = nombre;
        this.ramoContable = ramoContable;
        this.auditoria = auditoria;
    }

    public TipoBienAsegurado(String nombre, AuditoriaBasica auditoria) {
        this.nombre = nombre;
        this.auditoria = auditoria;
    }
