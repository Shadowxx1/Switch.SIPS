...
public class Giro extends BeanVO implements Serializable, Auditable, Comparable<Giro> {
    ...
    private CuentaBancariaPersona cuentasBancarias;
    /**
     *
     */
    @Column
    ...
    public Giro(Date fechaVencimiento, Double montoGiro, Integer numero) {
        this.numero = numero;
        this.fechaVencimiento = fechaVencimiento;
        this.montoGiro = montoGiro;
        this.domiciliado = false;
        this.cuentasBancarias=null;
        setEstatus(Dominios.EstatusGiro.PENDIENTE);
    }

    public Giro(Date fechaVencimiento, Double montoGiro, Boolean domiciliado, Integer numero, CuentaBancariaPersona cuentaBancariaPersona) {
        this.numero = numero;
        this.fechaVencimiento = fechaVencimiento;
        this.montoGiro = montoGiro;
        this.domiciliado = domiciliado;
        this.cuentasBancarias = cuentaBancariaPersona;
        setEstatus(Dominios.EstatusGiro.PENDIENTE);
    }
    ...
    public CuentaBancariaPersona getCuentasBancarias() {
        return cuentasBancarias;
    }

    public void setCuentasBancarias(CuentaBancariaPersona cuentasBancarias) {
