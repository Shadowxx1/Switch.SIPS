 ...
 */
public class RecaudoLookupController extends DefaultLookupController {

    public RecaudoLookupController() {
        ...
        this.setCodeSelectionWindow(RecaudoLookupController.TREE_GRID_FRAME);
        this.getLookupDataLocator().setNodeNameAttribute("nombre");
        this.setLookupValueObjectClassName(DetalleRecaudo.class.getName());
