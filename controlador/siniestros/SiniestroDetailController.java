    ...
    public SiniestroDetailController(String detailFramePath, GridControl gridControl, BeanVO beanVO, boolean aplicarLogicaNegocio) {
        ...
        if (beanVO != null) {
            ...
            if (((Siniestro) beanVO).getRecibo() != null) {
                if (((Siniestro) beanVO).getRecibo().getAsegurado() != null) {
                    vista.setTitle(vista.getTitle() + ((Siniestro) beanVO).getRecibo().getAsegurado().getNombreLargo());
                } else {
                    vista.setTitle(vista.getTitle() + ((Siniestro) beanVO).getRecibo().getPoliza().getContratante().getNombreLargo());
                }
            }
        }
    }
...
//        }
    ...
    public Response loadData(Class valueObjectClass) {
        ...
        Hibernate.initialize(p.getPagosParciales());
        Hibernate.initialize(p.getRecaudos());
...
//        persistentObject = p;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == ((SiniestroDetailFrame) vista).getSMSButton()) {
            ...
            Reporte r = new Reporte(Dominios.CategoriaReporte.SINIESTROS, 0, "SIN2", "Detalle de Siniestro", "", "", "", false, true, true, false);
...
//            } else {
            new ReporteController().mostrarReporte(l, new ArrayList<ParametroReporte>(0), r, "Estilo3.jrtx");
//            }
        ...
        } else if (e.getSource() == ((SiniestroDetailFrame) vista).getReporteRecudosButoon()) {
            Reporte r = new Reporte(Dominios.CategoriaReporte.SINIESTROS, 0, "RECAUDOS", "RECAUDOS DE SINIESTRO", "", "", "", false, true, true, false);
