        ...
        try {
            ...
            if (((SMSMasaDetailFrame) vista).isDia()) {
                ...
                switch (smsMasa.getTipo()) {
                    case CUMPLEAYO_SMS: {
                        smsMasa.setSms(new CrearSMSMarsivos(s, ((SMSMasaDetailFrame) vista).getGrid()).getCumpleayeros(smsMasa.getFecha(),
                                smsMasa.getTexto(), smsMasa.getMotivo(), "Productor", ab));
                        break;
                    }
                    case DOCUMENTO_SMS: {
                        smsMasa.setSms(new CrearSMSMarsivos(s, ((SMSMasaDetailFrame) vista).getGrid()).getDocumentosVencidos(smsMasa.getFecha(),
                                smsMasa.getTexto(), smsMasa.getMotivo(), "Productor", ab));
                        break;
                    }
                    case GIRO_SMS: {
                        hilo.start();
                        smsMasa.setSms(new CrearSMSMarsivos(s, ((SMSMasaDetailFrame) vista).getGrid()).getGirosVencidos(smsMasa.getFecha(),
                                smsMasa.getTexto(), smsMasa.getMotivo(), "Productor", ab));
                        break;
                    }
                    case RENOVACION_SMS: {
                        smsMasa.setSms(new CrearSMSMarsivos(s, ((SMSMasaDetailFrame) vista).getGrid()).getRenovacion(smsMasa.getFecha(),
                                smsMasa.getTexto(), smsMasa.getMotivo(), "Productor", ab));
                        break;
                    }
                    case TODOS_SMS: {
                        if (sql == null || sql.isEmpty()) {
                            smsMasa.setSms(new CrearSMSMarsivos(s, ((SMSMasaDetailFrame) vista).getGrid()).getTodos(
                                    smsMasa.getTexto(), smsMasa.getMotivo(), "Productor", ab));
                        } else {
                            smsMasa.setSms(new CrearSMSMarsivos(s, ((SMSMasaDetailFrame) vista).getGrid()).getFiltrados(sql, filteredColumns,
                                    smsMasa.getTexto(), smsMasa.getMotivo(), "Productor", ab));
                        }
                        break;
                    }
                ...
                switch (smsMasa.getTipo()) {
                    case CUMPLEAYO_SMS: {
                        smsMasa.setSms(
                                new CrearSMSMarsivos(s, ((SMSMasaDetailFrame) vista).getGrid()).getCumpleayeros(
                                smsMasa.getDesde(), smsMasa.getHasta(), smsMasa.getTexto(), smsMasa.getMotivo(), "Productor", ab));
                        break;
                    }
                    case DOCUMENTO_SMS: {
                        smsMasa.setSms(new CrearSMSMarsivos(s, ((SMSMasaDetailFrame) vista).getGrid()).getDocumentosVencidos(
                                smsMasa.getDesde(), smsMasa.getHasta(), smsMasa.getTexto(), smsMasa.getMotivo(), "Productor", ab));
                        break;
                    }
                    case GIRO_SMS: {
                        smsMasa.setSms(new CrearSMSMarsivos(s, ((SMSMasaDetailFrame) vista).getGrid()).getGirosVencidos(
                                smsMasa.getDesde(), smsMasa.getHasta(), smsMasa.getTexto(), smsMasa.getMotivo(), "Productor", ab));
                        break;
                    }
                    case RENOVACION_SMS: {
                        smsMasa.setSms(new CrearSMSMarsivos(s, ((SMSMasaDetailFrame) vista).getGrid()).getRenovacion(
                                smsMasa.getDesde(), smsMasa.getHasta(), smsMasa.getTexto(), smsMasa.getMotivo(), "Productor", ab));
                        break;
                    }
                }
