...
import com.productores.caja.controlador.LiquidacionDetailController;
...
import modelo.entidades.siniestros.dominio.DanoVehiculo;
...
import vista.facturacion.LiquidacionDetailFrame2;
...
import vista.polizas.recibos.TipoBienAseguradoGridFrame;
...
import vista.polizas.NuevaPolizaDialog;
...
// <editor-fold defaultstate="collapsed" desc="Personas">
    ...
    public void getTipoFianza() {
        new DefaultAllGridFrameController(DefaultMantenimientoGridFrame.class.getName(), null, TipoFianza.class.getName(), "Tipo de Fianza");
    }
...
// <editor-fold defaultstate="collapsed" desc="Polizas">
    public void getPolizaNuevo() {
        NuevaPolizaDialog pol = new NuevaPolizaDialog();
...
// <editor-fold defaultstate="collapsed" desc="Recibos">
    public void getReciboNuevo() {
        ...
        if (numPol.isOk()) {
            switch (numPol.getPoliza().getRamoPoliza().getRamoContable()) {
                case PERSONA:
                    new ReciboPersonasDetailController(ReciboPersonasDetailFrame.class.getName(), null, numPol.getRecibo(), true, null, numPol.isNuevo());
                    break;
                case VEHICULO:
                    new ReciboVehiculosDetailController(ReciboVehiculosDetailFrame.class.getName(), null, numPol.getRecibo(), true, null, numPol.isNuevo());
                    break;
                case FIANZA:
                    new ReciboFianzasDetailController(ReciboFianzaDetailFrame.class.getName(), null, numPol.getRecibo(), true, null, numPol.isNuevo());
                    break;
                case PATRIMONIAL:
                    new ReciboPatrimonialesDetailController(ReciboPatrimonialDetailFrame.class.getName(), null, numPol.getRecibo(), true, null, numPol.isNuevo());
                    break;
...
// <editor-fold defaultstate="collapsed" desc="Siniestros">
    ...
    public void getDañoVehiculo() {
        new DefaultAllGridFrameController(DañoVehiculoGridFrame.class.getName(), null, DanoVehiculo.class.getName(), null);
    }
...
// </editor-fold>
    ...
    public void getNuevaLiquidacion() {
        new LiquidacionDetailFrameController(LiquidacionDetailFrame2.class.getName(), null, null, true);
    }

    public void getTipoBienAsegurado() {
        new DefaultAllGridFrameController(TipoBienAseguradoGridFrame.class.getName(), null, TipoBienAsegurado.class.getName(), "Tipo de Bien Asegurado");
    }

    public void getLiquidaciones() {
        new LiquidacionDetailController(null, null);
    }
    ...
    public void getTipoMovimiento() {
        new DefaultAllGridFrameController(DefaultMantenimientoGridFrame.class.getName(), null, TipoMovimiento.class.getName(), "Tipo de Movimiento en Caja");
    }
    ...
    public void getExit() {
        ///new AsientoDetailController(null, null, null);
        new LiquidacionDetailController(null, null);
//        new DefaultDetailFrameController(LiquidacionDetailFrame.class.getName(), null, null, false);
    ...
    public void getTipoIngreso() {
        new DefaultAllGridFrameController(DefaultMantenimientoGridFrame.class.getName(), null, TipoIngresoCaja.class.getName(), "Tipo Ingreso a Caja");
    }
...
// </editor-fold>
    ...
    public void getDanoVehiculo() {
        new DefaultGridFrameController(DefaultMantenimientoGridFrame.class.getName(), null, DanoVehiculo.class.getName(), "Daño de Vehiculo");
    }
