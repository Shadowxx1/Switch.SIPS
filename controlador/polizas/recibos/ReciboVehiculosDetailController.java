 ...
 */
public class ReciboVehiculosDetailController extends DefaultDetailFrameController implements ActionListener {

    public ReciboVehiculosDetailController(
        ...
        try {
            ...
            vista = new ReciboVehiculosDetailFrame();//t.newInstance();
...
//                ((ReciboDetailFrame) (vista)).setVisibleBeneficiarios(v3);
            ...
            if (td2 != null && td2.getId() != null) {
                ...
                beanVO = ((ReciboVehiculos) vista.getMainPanel().getVOModel().getValueObject());
                s.update(beanVO);
                ...
                ReciboVehiculos recibo = (ReciboVehiculos) beanVO;
                ...
                Response r = null;
                try {
                    r = ((ReciboVehiculosDetailFrame) vista).getGridDistribucionController().insertRecords(null, ds);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
                if (r != null && r instanceof VOListResponse) {
                    for (Object object : ((VOListResponse) r).getRows()) {
                        ((ReciboVehiculos) vista.getMainPanel().getVOModel().getValueObject()).getDistribuciones().add((Distribucion) object);
                    }
                }
    ...
    public Response loadData(Class valueObjectClass) {
        if (((ReciboVehiculos) beanVO).getId() != null) {
            Session s = HibernateUtil.getSessionFactory().openSession();
            ReciboVehiculos p = (ReciboVehiculos) s.get(ReciboVehiculos.class, ((ReciboVehiculos) beanVO).getId());
    ...
    public void createPersistentObject(ValueObject PersistentObject) throws Exception {
        PersistentObject = new ReciboVehiculos();
        ((ReciboVehiculos) PersistentObject).setZona(Principal.defaultData.recibo.getZona());
        vista.getMainPanel().getVOModel().setValueObject(PersistentObject);
    }

    @Override
    public Response logicaNegocio(ValueObject persistentObject) {
        ReciboVehiculos recibo = (ReciboVehiculos) persistentObject;
...
//        }
    ...
    public Response insertRecord(ValueObject newPersistentObject) throws Exception {
        ...
        try {
            ...
            ReciboVehiculos rr = (ReciboVehiculos) newPersistentObject;
            s = HibernateUtil.getSessionFactory().openSession();
            Long cant = (Long) s.createQuery("SELECT count(P) FROM " + ReciboVehiculos.class.getName() + " as P WHERE P.numero=? AND P.poliza.numero=? AND P.poliza.compania.id=?").
            ...
            if (cant == 0) {
                ...
                if (((ReciboVehiculos) newPersistentObject).getFinanciamiento() != null && ((ReciboVehiculos) newPersistentObject).getFinanciamiento().getId() != null) {
                    ((ReciboVehiculos) newPersistentObject).setFinanciado(true);
                } else {
                    ((ReciboVehiculos) newPersistentObject).setFinanciado(false);
                    ((ReciboVehiculos) newPersistentObject).setFinanciamiento(null);
                }
...
//            AuditLogInterceptor.INSTANCE2.setSession(s);
            ReciboVehiculos r3 = (ReciboVehiculos) oldPersistentObject;
            if ((!r3.getPoliza().getNumero().equalsIgnoreCase(r3.getPoliza().getNumero())) || (!r3.getNumero().equalsIgnoreCase(r3.getNumero()))) {
                Long cant = (Long) s.createQuery("SELECT count(P) FROM " + ReciboVehiculos.class.getName() + " as P WHERE P.numero=? AND P.poliza.numero=? AND P.poliza.compania.id=?").
                        setString(0, ((ReciboVehiculos) persistentObject).getNumero()).
                        setString(1, ((ReciboVehiculos) persistentObject).getPoliza().getNumero()).
                        setLong(2, ((ReciboVehiculos) persistentObject).getPoliza().getCompania().getId()).
                        list().get(0);
                if (cant != 0) {
            ...
            if (((ReciboVehiculos) persistentObject).getFinanciamiento() != null && ((ReciboVehiculos) persistentObject).getFinanciamiento().getId() != null) {
                ((ReciboVehiculos) persistentObject).setFinanciado(true);
            } else {
                ((ReciboVehiculos) persistentObject).setFinanciado(false);
                ((ReciboVehiculos) persistentObject).setFinanciamiento(null);
            }
    ...
    public void actionPerformed(ActionEvent e) {
        ReciboVehiculos r = ((ReciboVehiculos) vista.getMainPanel().getVOModel().getValueObject());
        if (e.getSource() == ((ReciboVehiculosDetailFrame) vista).getFinanciamientoButton()) {
            ...
            if (f != null && f.getId() != null) {
                ...
                new FinanciamientoDetailController(FinanciamientoDetailFrame.class.getName(), null, null, true, (ReciboVehiculos) vista.getMainPanel().getVOModel().getValueObject(), true);
            }
        } else if (e.getSource() == ((ReciboVehiculosDetailFrame) vista).getSMSButton()) {
        ...
        } else if (e.getSource() == ((ReciboVehiculosDetailFrame) vista).getEmailButton()) {
