 ...
 */
public class CopiarCertificadosLookupController extends DefaultLookupController {
    ...
    public CopiarCertificadosLookupController(Long PolizaId) {
        this.polizaId = PolizaId;
        ...
        setVisibleColumn("poliza.ramoPoliza.nombreCorto", true);
            ...
            try {
                ...
                if (polizaId != null) {
                    filteredColumns.put(
                            "poliza.id",
                            new FilterWhereClause[]{
                                new FilterWhereClause("poliza.id", "=", polizaId),
                                null
                            });
                }
