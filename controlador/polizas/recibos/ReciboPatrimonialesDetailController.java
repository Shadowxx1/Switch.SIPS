...
import modelo.entidades.polizas.recibos.maestra.ReciboPatrimonial;
 ...
 */
public class ReciboPatrimonialesDetailController extends DefaultDetailFrameController implements ActionListener {

    public ReciboPatrimonialesDetailController(
        ...
        try {
            ...
            vista = new ReciboPatrimonialDetailFrame();//t.newInstance();
...
//                ((ReciboDetailFrame) (vista)).setVisibleBeneficiarios(v3);
            ...
            if (td2 != null && td2.getId() != null) {
                ...
                beanVO = ((ReciboPatrimonial) vista.getMainPanel().getVOModel().getValueObject());
                s.update(beanVO);
                ...
                ReciboPatrimonial recibo = (ReciboPatrimonial) beanVO;
                ...
                Response r = null;
                try {
                    r = ((ReciboPatrimonialDetailFrame) vista).getGridDistribucionController().insertRecords(null, ds);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
                if (r != null && r instanceof VOListResponse) {
                    for (Object object : ((VOListResponse) r).getRows()) {
                        ((ReciboPatrimonial) vista.getMainPanel().getVOModel().getValueObject()).getDistribuciones().add((Distribucion) object);
                    }
                }
                vista.reloadGridsData();
            }
    ...
    public Response loadData(Class valueObjectClass) {
        if (((ReciboPatrimonial) beanVO).getId() != null) {
            Session s = HibernateUtil.getSessionFactory().openSession();
            ReciboPatrimonial r = (ReciboPatrimonial) s.get(ReciboPatrimonial.class, ((ReciboPatrimonial) beanVO).getId());
            Hibernate.initialize(r.getObservaciones());
            Hibernate.initialize(r.getDocumentos());
//            Hibernate.initialize(p.getBeneficiarios2());
            Hibernate.initialize(r.getDevoluciones());
            Hibernate.initialize(r.getDistribuciones());
            Hibernate.initialize(r.getCoberturas());
            Hibernate.initialize(r.getBienesPatrimoniales());
            s.close();
            beanVO = r;
        }
    ...
    public void createPersistentObject(ValueObject PersistentObject) throws Exception {
        PersistentObject = new ReciboPatrimonial();
        ((ReciboPatrimonial) PersistentObject).setZona(Principal.defaultData.recibo.getZona());
        vista.getMainPanel().getVOModel().setValueObject(PersistentObject);
    }

    @Override
    public Response logicaNegocio(ValueObject persistentObject) {
        ReciboPatrimonial recibo = (ReciboPatrimonial) persistentObject;
...
//        }
    ...
    public Response insertRecord(ValueObject newPersistentObject) throws Exception {
        ...
        try {
            ...
            ReciboPatrimonial rr = (ReciboPatrimonial) newPersistentObject;
            s = HibernateUtil.getSessionFactory().openSession();
            Long cant = (Long) s.createQuery("SELECT count(P) FROM " + ReciboPatrimonial.class.getName() + " as P WHERE P.numero=? AND P.poliza.numero=? AND P.poliza.compania.id=? AND P.poliza.ramoPoliza.id=?").
            ...
            if (cant == 0) {
                ...
                if (((ReciboPatrimonial) newPersistentObject).getFinanciamiento() != null && ((ReciboPatrimonial) newPersistentObject).getFinanciamiento().getId() != null) {
                    ((ReciboPatrimonial) newPersistentObject).setFinanciado(true);
                } else {
                    ((ReciboPatrimonial) newPersistentObject).setFinanciado(false);
                    ((ReciboPatrimonial) newPersistentObject).setFinanciamiento(null);
                }
    ...
    public Response updateRecord(ValueObject oldPersistentObject, ValueObject persistentObject) throws Exception {
        Session s = null;
        ReciboPatrimonial rr = (ReciboPatrimonial) persistentObject;
        try {
            vista.saveGridsData();
            //s = HibernateUtil.getSessionFactory().openSession(AuditLogInterceptor.INSTANCE2);
            s = HibernateUtil.getSessionFactory().openSession();
//            AuditLogInterceptor.INSTANCE2.setSession(s);
            ReciboPatrimonial r3 = (ReciboPatrimonial) oldPersistentObject;
            ...
            if (((ReciboPatrimonial) persistentObject).getFinanciamiento() != null && ((ReciboPatrimonial) persistentObject).getFinanciamiento().getId() != null) {
                ((ReciboPatrimonial) persistentObject).setFinanciado(true);
            } else {
                ((ReciboPatrimonial) persistentObject).setFinanciado(false);
                ((ReciboPatrimonial) persistentObject).setFinanciamiento(null);
            }
    ...
    public void actionPerformed(ActionEvent e) {
        ReciboPatrimonial r = ((ReciboPatrimonial) vista.getMainPanel().getVOModel().getValueObject());
        if (e.getSource() == ((ReciboPatrimonialDetailFrame) vista).getFinanciamientoButton()) {
            ...
            if (f != null && f.getId() != null) {
                ...
                new FinanciamientoDetailController(FinanciamientoDetailFrame.class.getName(), null, null, true, (ReciboPatrimonial) vista.getMainPanel().getVOModel().getValueObject(), true);
            }
        } else if (e.getSource() == ((ReciboPatrimonialDetailFrame) vista).getSMSButton()) {
        ...
        } else if (e.getSource() == ((ReciboPatrimonialDetailFrame) vista).getEmailButton()) {
