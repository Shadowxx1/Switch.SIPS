...
public class ReciboLookupController extends DefaultLookupController {
    ...
    class ReciboDataLocator extends DefaultLookupDataLocator {
        ...
        private SiniestroDetailFrame siniestroDetailFrame;

        public ReciboDataLocator(String classFullName) {
            super(classFullName);
        }

        public ReciboDataLocator(String classFullName, SiniestroDetailFrame siniestroDetailFrame) {
            super(classFullName);
            this.siniestroDetailFrame = siniestroDetailFrame;
        }        
