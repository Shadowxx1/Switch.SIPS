 ...
 */
public class ReciboFianzasDetailController extends DefaultDetailFrameController implements ActionListener {

    public ReciboFianzasDetailController(
        ...
        try {
            ...
            vista = new ReciboFianzaDetailFrame();//t.newInstance();
...
//                ((ReciboDetailFrame) (vista)).setVisibleBeneficiarios(v3);
            ...
            if (td2 != null && td2.getId() != null) {
                ...
                beanVO = ((ReciboFianzas) vista.getMainPanel().getVOModel().getValueObject());
                s.update(beanVO);
                ...
                ReciboFianzas recibo = (ReciboFianzas) beanVO;
                ...
                Response r = null;
                try {
                    r = ((ReciboFianzaDetailFrame) vista).getGridDistribucionController().insertRecords(null, ds);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
                if (r != null && r instanceof VOListResponse) {
                    for (Object object : ((VOListResponse) r).getRows()) {
                        ((ReciboFianzas) vista.getMainPanel().getVOModel().getValueObject()).getDistribuciones().add((Distribucion) object);
                    }
                }
    ...
    public Response loadData(Class valueObjectClass) {
        if (((ReciboFianzas) beanVO).getId() != null) {
            Session s = HibernateUtil.getSessionFactory().openSession();
            ReciboFianzas p = (ReciboFianzas) s.get(ReciboFianzas.class, ((ReciboFianzas) beanVO).getId());
    ...
    public void createPersistentObject(ValueObject PersistentObject) throws Exception {
        PersistentObject = new ReciboFianzas();
        ((ReciboFianzas) PersistentObject).setZona(Principal.defaultData.recibo.getZona());
        vista.getMainPanel().getVOModel().setValueObject(PersistentObject);
    }

    @Override
    public Response logicaNegocio(ValueObject persistentObject) {
        ReciboFianzas recibo = (ReciboFianzas) persistentObject;
...
//        }
    ...
    public Response insertRecord(ValueObject newPersistentObject) throws Exception {
        ...
        try {
            ...
            ReciboFianzas rr = (ReciboFianzas) newPersistentObject;
            s = HibernateUtil.getSessionFactory().openSession();
            Long cant = (Long) s.createQuery("SELECT count(P) FROM " + ReciboFianzas.class.getName() + " as P WHERE P.numero=? AND P.poliza.numero=? AND P.poliza.compania.id=? AND P.poliza.ramoPoliza.id=?").
            ...
            if (cant == 0) {
                ...
                if (((ReciboFianzas) newPersistentObject).getFinanciamiento() != null && ((ReciboFianzas) newPersistentObject).getFinanciamiento().getId() != null) {
                    ((ReciboFianzas) newPersistentObject).setFinanciado(true);
                } else {
                    ((ReciboFianzas) newPersistentObject).setFinanciado(false);
                    ((ReciboFianzas) newPersistentObject).setFinanciamiento(null);
                }
                ...
                throw new Exception("Número de poliza, recibo y Ramo ya existe");
            }
        } catch (Exception ex) {
    ...
    public Response updateRecord(ValueObject oldPersistentObject, ValueObject persistentObject) throws Exception {
        Session s = null;
        ReciboFianzas rr = (ReciboFianzas) persistentObject;
        try {
            vista.saveGridsData();
            //s = HibernateUtil.getSessionFactory().openSession(AuditLogInterceptor.INSTANCE2);
            s = HibernateUtil.getSessionFactory().openSession();
//            AuditLogInterceptor.INSTANCE2.setSession(s);
            ReciboFianzas r3 = (ReciboFianzas) oldPersistentObject;
            ...
            if (((ReciboFianzas) persistentObject).getFinanciamiento() != null && ((ReciboFianzas) persistentObject).getFinanciamiento().getId() != null) {
                ((ReciboFianzas) persistentObject).setFinanciado(true);
            } else {
                ((ReciboFianzas) persistentObject).setFinanciado(false);
                ((ReciboFianzas) persistentObject).setFinanciamiento(null);
            }
    ...
    public void actionPerformed(ActionEvent e) {
        ReciboFianzas r = ((ReciboFianzas) vista.getMainPanel().getVOModel().getValueObject());
        if (e.getSource() == ((ReciboFianzaDetailFrame) vista).getFinanciamientoButton()) {
            ...
            if (f != null && f.getId() != null) {
                ...
                new FinanciamientoDetailController(FinanciamientoDetailFrame.class.getName(), null, null, true, (ReciboFianzas) vista.getMainPanel().getVOModel().getValueObject(), true);
            }
        } else if (e.getSource() == ((ReciboFianzaDetailFrame) vista).getSMSButton()) {
        ...
        } else if (e.getSource() == ((ReciboFianzaDetailFrame) vista).getEmailButton()) {
