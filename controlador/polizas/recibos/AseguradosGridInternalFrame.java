 ...
 */
public class AseguradosGridInternalFrame extends DefaultGridInternalController {

    public AseguradosGridInternalFrame(String classNameModelFullPath, String getMethodName, GridControl miGrid, ArrayList<DefaultGridInternalController> listSubGrids) {
    ...
    public Response loadData(int action,
        ...
        try {
            ...
            String sql = "FROM " + Asegurado.class.getName() + " AS C ";
        ...
        if (getSet() != null) {
            ...
            try {
                ...
                for (Object o : newValueObjects) {
                    ((Asegurado) o).setCertificado((Certificado) beanVO);
//                    s.save(o);
                }
                s.update(beanVO);
